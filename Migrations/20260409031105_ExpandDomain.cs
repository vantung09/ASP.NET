    ...
    public partial class ExpandDomain : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "CAT-FOOD", "Food", "Food items" },
                    { 2, "CAT-TECH", "Technology", "Tech items" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Description", "Price", "ProductCode", "ProductName", "Unit" },
                values: new object[,]
                {
                    { 1, 1, "Fresh apple", 2.50m, "PRD-APPLE", "Apple", "kg" },
                    { 2, 2, "Office laptop", 899.00m, "PRD-LAPTOP", "Laptop", "pcs" }
                });
